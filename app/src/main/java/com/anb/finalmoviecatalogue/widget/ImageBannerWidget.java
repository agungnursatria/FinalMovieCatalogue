...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.anb.finalmoviecatalogue.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.anb.finalmoviecatalogue.EXTRA_ITEM";
